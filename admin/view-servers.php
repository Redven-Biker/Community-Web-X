                                ...
                                <form class="form-inline form-inline search mt-lg-0" role="search">
                                    <div class="search-bar">
                                        <input type="text" id="search" onkeyup="myFunction()"
                                            ...
                                            placeholder="Search...">
                                        <a href="create-server.php"><input type="button"
                                                class="mt-4 mb-4 btn btn-primary" value="Create Server"></a>
                                    </div>
                                </form>
                            </div>
...
?></td>
    <form action='inc/delete_entry.php' method='post'>
        <?php
                                echo '
<td class="text-center"><button type="submit" name="deleteservers" class="btn btn-outline-danger btn-rounded mb-2"  value="' . $data['id'] . '">Delete</button></td>'; ?>
