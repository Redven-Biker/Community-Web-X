            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                <div class="widget widget-chart-three">
                    <div class="widget-heading">
                        <div class="">
                            <h5 class="">NOTIFICATION RIGHT</h5>
                        </div>
                    </div>
                                ...
                                <form class="form-inline form-inline search mt-lg-0" role="search">
                                    <div class="search-bar">
                                        <input type="text" id="search" onkeyup="myFunction()"
                                            ...
                                            placeholder="Search...">
                                        <a href="create-notification-right.php"><input type="button"
...
<tr>
    ...
    <form action='inc/delete_entry.php' method='post'>
        <?php
                                                                echo '
                                <td class="text-center"><button type="submit" name="deletenotificationright" class="btn btn-outline-danger btn-rounded mb-2"  value="' . $data['id'] . '">Delete</button></td>'; ?>
